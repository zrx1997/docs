...
![image-20210928101637544](https://raw.githubusercontent.com/adcwb/storages/master/image-20210928101637544.png)
...
func (fl *FileLogger) Info(msg string) {
	if checkFileIsExist(fl.filename) {
		file, err := os.OpenFile(fl.filename, os.O_APPEND|os.O_WRONLY, 0644)
		if err != nil {
			panic(err)
		}
		file.WriteString(msg)
	} else {
		file, err := os.OpenFile(fl.filename, os.O_CREATE|os.O_WRONLY, 0644)
		if err != nil {
			panic(err)
		}
		file.WriteString(msg)
