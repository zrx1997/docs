...
​	下面的版本号可能并不是最新的，但总体来说安装教程是类似的。Go语言更新迭代比较快，推荐使用较新版本，体验最新特性。
...
#配置环境变量，建议写入到/etc/profile文件中，开机自动生效
...
# 下载msi包，双击下载好的安装包，下一步原则
	...
	由于国内访问不到，所以我们需要换一个PROXY，这里推荐使用https://goproxy.io或https://goproxy.cn。
